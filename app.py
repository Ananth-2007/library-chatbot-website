...
def ask_chatbot():
    ...
    response_data = {"type": "text", "content": "I'm sorry, I don't understand that."}

    step = conversation_state.get('step')
    ...
    if step == 'awaiting_name':
        ...
        if "list" in user_message and "available" in user_message:
            ...
            match = re.search(r"book\s+'(.*?)'", user_message)
            if match:
